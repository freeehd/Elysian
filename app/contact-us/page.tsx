      ...
      <main className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 relative z-10">
        <FadeInSection>
          ...
          <p className="text-center text-lg mb-16 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            ...
            out to us directly through our contact information.
          </p>
        </FadeInSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* <FadeInSection>
              <div className="bg-white dark:bg-rich-black-200/70 rounded-xl shadow-lg p-8 border border-gray-100 dark:border-rich-black-300">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Connect With Us</h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <a 
                    href="#" 
                    className="flex flex-col items-center justify-center p-4 rounded-lg bg-gray-50 dark:bg-rich-black-300/50 hover:bg-teal/10 dark:hover:bg-teal/20 transition-colors group"
                  >
                    <Facebook className="w-6 h-6 text-teal dark:text-teal-400 group-hover:text-caribbean dark:group-hover:text-caribbean-400 transition-colors" />
                    <span className="mt-2 text-sm text-gray-600 dark:text-gray-400 group-hover:text-teal dark:group-hover:text-teal-400 transition-colors">Facebook</span>
                  </a>
                  <a 
                    href="#" 
                    className="flex flex-col items-center justify-center p-4 rounded-lg bg-gray-50 dark:bg-rich-black-300/50 hover:bg-teal/10 dark:hover:bg-teal/20 transition-colors group"
                  >
                    <Twitter className="w-6 h-6 text-teal dark:text-teal-400 group-hover:text-caribbean dark:group-hover:text-caribbean-400 transition-colors" />
                    <span className="mt-2 text-sm text-gray-600 dark:text-gray-400 group-hover:text-teal dark:group-hover:text-teal-400 transition-colors">Twitter</span>
                  </a>
                  <a 
                    href="#" 
                    className="flex flex-col items-center justify-center p-4 rounded-lg bg-gray-50 dark:bg-rich-black-300/50 hover:bg-teal/10 dark:hover:bg-teal/20 transition-colors group"
                  >
                    <Instagram className="w-6 h-6 text-teal dark:text-teal-400 group-hover:text-caribbean dark:group-hover:text-caribbean-400 transition-colors" />
                    <span className="mt-2 text-sm text-gray-600 dark:text-gray-400 group-hover:text-teal dark:group-hover:text-teal-400 transition-colors">Instagram</span>
                  </a>
                  <a 
                    href="#" 
                    className="flex flex-col items-center justify-center p-4 rounded-lg bg-gray-50 dark:bg-rich-black-300/50 hover:bg-teal/10 dark:hover:bg-teal/20 transition-colors group"
                  >
                    <Linkedin className="w-6 h-6 text-teal dark:text-teal-400 group-hover:text-caribbean dark:group-hover:text-caribbean-400 transition-colors" />
                    <span className="mt-2 text-sm text-gray-600 dark:text-gray-400 group-hover:text-teal dark:group-hover:text-teal-400 transition-colors">LinkedIn</span>
                  </a>
                </div>
              </div>
            </FadeInSection> */}
