      ...
      <main className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl font-bold text-center mb-8 text-gray-900 dark:text-white">
            Contact <span className="text-[#3584C0]">Us</span>
          </h1>
          ...
          >
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center">
                  <Mail className="w-6 h-6 text-[#3584C0] mr-2" />
                  <a href="mailto:info@elysian-innovations.com" className="text-gray-600 dark:text-gray-300 hover:text-[#3584C0]">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-[#3584C0] hover:text-[#2d6fa3]">
