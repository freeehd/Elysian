      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="text-xl mb-4 block text-white/80">Strategy</span>
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Elysian Innovations empowers your organization with clear, actionable plans aligned with your long-term
              goals. We understand that a well-defined strategy is vital for navigating today's complex business
              landscape.
            </p>
          </motion.div>
        </FadeInSection>
