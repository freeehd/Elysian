      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xl font-medium text-white/90">Enterprise Resource Planning (ERP)</p>
            ...
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              We specialize in delivering comprehensive ERP solutions tailored to optimize your business processes,
              streamline operations, and drive growth. Explore how our expertise can transform your enterprise and
