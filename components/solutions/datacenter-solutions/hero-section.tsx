      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xl font-medium text-white/90">DataCentre Solutions</p>
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-white lg:text-6xl">
              Next-Gen Datacenter Solutions
            </h1>
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              We specialize in delivering robust and scalable datacenter solutions tailored to meet the unique needs of
              your business. Explore how our comprehensive offerings can optimize your data management infrastructure
