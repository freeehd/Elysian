...
const services = [
  {
    ...
    description:
      "Customized design and implementation of datacenter infrastructure to meet your specific requirements.",
  },
  {
    icon: Settings,
  ...
  },
  {
    ...
    description:
      "Seamlessly integrate on-premises datacenter solutions with cloud services for hybrid cloud environments.",
  },
]
