      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xl font-medium text-white/90">Application Modernization</p>
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-white lg:text-6xl">Reimagine Your Software</h1>
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              We empower you to unlock the full potential of your applications, transforming them into high-performing
              solutions that stay relevant in an ever-evolving digital landscape.
            </p>
            <Button
              size="lg"
