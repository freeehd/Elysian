    ...
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mb-16 max-w-3xl text-center text-lg text-gray-600">
          As an industry leader in application modernization, we deliver a full
          range of services to support your objectives. Our services include:
        </p>
          ...
          {services.map((service, index) => (
            ...
            >
              <CardContent className="p-6">
                <div
                  className={`w-16 h-16 mb-6 rounded-xl flex items-center justify-center bg-gradient-to-r ${
                    index % 2 === 0
