    ...
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="mb-4 text-4xl font-bold text-gray-900">
          Our <span className="text-[#008080]">Offering</span>
        </h2>
        <p className="mb-16 max-w-3xl text-lg text-gray-600">
          We specialize in delivering top-notch Infrastructure Services designed
          to address your specific requirements. Our broad range of services
