      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xl font-medium text-white/90">Infrastructure Solutions</p>
            ...
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              In the dynamic digital landscape, a robust and scalable IT infrastructure is essential for business
              continuity and growth. Elysian's Infrastructure Solutions provide comprehensive services that ensure your
              systems are secure, efficient, and adaptable. From cloud migration to network security, we cover all
              aspects of IT infrastructure to help you achieve operational excellence.
            </p>
            <Button
              size="lg"
