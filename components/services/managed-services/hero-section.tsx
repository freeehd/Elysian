      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xl font-medium text-white/90">Managed Services</p>
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-white lg:text-6xl">
              Maximize Efficiency and Adaptability
            </h1>
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              Elysian Innovation enhances your team's capabilities across the board, including management, monitoring,
              incident detection, disaster recovery, backup solutions, and comprehensive security measures.
            </p>
            <Button
              size="lg"
