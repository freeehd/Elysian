...
const services = [
  ...
  },
  {
    ...
    description:
      "Embed security into every phase of your DevOps pipeline to ensure robust and secure applications.",
    icon: Shield,
    gradient: "from-blue-600 to-blue-800",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInSection>
          ...
          <p className="text-xl text-gray-600 mb-16 max-w-3xl">
            Our offerings encompass a wide array of solutions, including but not
            limited to:
          </p>
        </FadeInSection>
