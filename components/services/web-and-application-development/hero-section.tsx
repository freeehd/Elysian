      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xl font-medium text-white/90">Web & Application Development</p>
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-white lg:text-6xl">
              Elevate Your Digital Presence
            </h1>
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              Elysian specializes in creating innovative web and application solutions that drive your business forward.
              We turn your ideas into dynamic digital experiences.
            </p>
            <Button
              size="lg"
