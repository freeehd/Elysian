    ...
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="mb-4 text-4xl font-bold">
          <span className="text-[#008080]">OUR OFFERING</span>
        </h2>
        <p className="mb-16 max-w-3xl text-lg text-gray-600">
          As a premier Web and Application Development firm, Elysian offers a
          comprehensive range of solutions tailored to your unique digital
          needs. Our services include, but are not limited to:
        </p>
          ...
          {offerings.map((offering) => (
            ...
            >
              <CardContent className="p-8">
                <div
                  className={`w-16 h-16 mb-6 rounded-xl flex items-center justify-center bg-gradient-to-r ${offering.gradient}`}
                >
