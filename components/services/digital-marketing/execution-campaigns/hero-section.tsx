      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          ...
          >
            ...
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-white lg:text-6xl">Execution & Campaigns</h1>
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              Elysian Innovation delivers high-performing digital marketing campaigns that drive measurable results. Our
              execution-focused approach ensures your marketing initiatives are implemented with precision and optimized
              for maximum impact.
            </p>
            <Button
              size="lg"
