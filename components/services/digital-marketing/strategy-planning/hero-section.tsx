      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <FadeInSection>
          ...
          >
            ...
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-white lg:text-6xl">Strategy & Planning</h1>
            <p className="mb-8 text-xl leading-relaxed text-white/90">
              Elysian Innovation delivers data-driven digital marketing strategies that transform your online presence.
              Our strategic planning approach focuses on research, analysis, and creating a roadmap for sustainable
              growth.
            </p>
            <Button
              size="lg"
