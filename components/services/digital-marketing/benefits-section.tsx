...
const benefits = [
  {
    ...
    description:
      "Our strategies are built on comprehensive analytics and market insights, ensuring every decision is backed by data for maximum effectiveness and ROI.",
  },
  {
    title: "Strategic Planning",
    description:
      "We develop detailed roadmaps with clear milestones and KPIs, providing a structured approach to achieving your marketing objectives and sustainable growth.",
  },
  {
    title: "Integrated Marketing",
    description:
      "Our holistic approach ensures all marketing channels work together cohesively, creating a consistent brand experience and amplifying your message across platforms.",
  },
  {
    title: "Continuous Optimization",
    description:
      "We implement ongoing performance analysis and refinement, ensuring your marketing strategy evolves with changing market conditions and consistently delivers results.",
  },
]
