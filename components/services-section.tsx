        ...
        <FadeInSection>
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-black dark:text-white">
              OUR{" "}
              <span className="text-[#6fabd8] dark:text-[#6fabd8]">
                SERVICES
              </span>
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Leveraging advanced technologies and industry expertise, we
              deliver comprehensive solutions designed to accelerate innovation
          ...
          {services.map((service) => (
            <FadeInSection key={service.title}>
              <div className="group bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                ...
                <Link
                  href={service.href}
                  className="text-[#008080] hover:text-[#6D28D9] dark:text-[#008080] dark:hover:text-[#C4B5FD] font-medium inline-flex items-center mt-auto"
                >
                  Learn More
                  <svg
