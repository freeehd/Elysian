      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInSection>
          <h2 className="text-4xl font-bold mb-16 text-gray-800">
            Our Pillars of <span className="text-[#008080]">Expertise</span>
          </h2>
        </FadeInSection>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 bg-[#008080] bg-opacity-10 rounded-xl flex items-center justify-center">
                        <pillar.icon className="w-8 h-8 text-[#008080]" />
                      </div>
                    </div>
                    <div>
