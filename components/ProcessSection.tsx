...
const processSteps = [
  ...
  },
  {
    ...
    content:
      "We will initiate internal discussions to clearly define the project scope, objectives, and requirements.",
  ...
  },
  {
    title: "Start work",
    content:
      "Once both parties finalize the contractual agreements, we would officially kick off the project.",
  ...
  },
  {
    ...
    content:
      "Regular meetings to discuss progress, gather feedback, and implement improvements.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              ...
              <span className="text-[#008080]">PROCESS</span>
            </h2>
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  <AccordionTrigger
                    ...
                    className="hover:text-[#008080] hover:no-underline text-left py-4 text-gray-900 dark:text-gray-100"
                  >
