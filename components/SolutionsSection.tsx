    ...
    <section className="py-24 px-4 md:px-6 lg:px-8 bg-[#050505] relative overflow-hidden">
      ...
      <div className="absolute right-0 top-0 w-1/3 h-full opacity-20">
        <div className="transform rotate-45 translate-x-1/2 -translate-y-1/4">
          <div className="w-96 h-96 bg-gradient-to-r from-[#008080]/30 to-[#6fabd8]/30" />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-[#008080]">ELYSIAN</span>{" "}
            <span className="text-[#6fabd8]">SOLUTIONS</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover innovative solutions that drive business transformation and
            sustainable growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {solutions.map((solution) => (
            ...
            >
              ...
              <Link
                href={solution.href}
                className="text-[#008080] hover:text-[#6fabd8] font-medium inline-flex items-center"
              >
                Learn More
              </Link>
            </div>
