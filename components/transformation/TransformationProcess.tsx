...
const steps = [
  {
    ...
    description:
      "We begin with a thorough assessment of your current systems and processes, followed by the development of a detailed transformation plan.",
    icon: ClipboardList,
  },
  {
    number: "02",
    ...
    description:
      "Our team of experts works closely with you to implement the transformation strategy, ensuring minimal disruption to your business operations.",
    icon: Rocket,
  },
  {
    number: "03",
    title: "Optimization",
    description:
      "Post-implementation, we continuously monitor and optimize your systems to ensure they deliver maximum value.",
    icon: Gauge,
  },
  {
    number: "04",
    ...
    description:
      "We provide ongoing support and training to help your team adapt to new technologies and processes, ensuring long-term success.",
    icon: GraduationCap,
  },
]
  ...
  return (
    <section className="py-24 px-4 md:px-6 lg:px-8 bg-gradient-to-r from-teal to-caribbean text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <FadeInSection>
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">Our Transformation Process</h2>
        </FadeInSection>
