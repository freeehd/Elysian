      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInSection>
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="text-xl mb-4 block text-white/80">Consulting</span>
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Elysian Innovations empowers your organization with innovative solutions and a strategic roadmap for
              success. Our team of experienced consultants is here to guide you every step of the way.
            </p>
          </motion.div>
        </FadeInSection>
      </div>
